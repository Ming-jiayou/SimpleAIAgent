...
using SimpleTranslationAIAgent.Services;
using SimpleTranslationAIAgent.ViewModels.Pages;
using SimpleTranslationAIAgent.ViewModels.Windows;
using SimpleTranslationAIAgent.Views.Pages;
using SimpleTranslationAIAgent.Views.Windows;
...
namespace SimpleTranslationAIAgent
{
    /// <summary>
    ...
    public partial class App
    {
        ...
        private static readonly IHost _host = Host
            ...
            .ConfigureAppConfiguration(c => { c.SetBasePath(System.AppContext.BaseDirectory); })
